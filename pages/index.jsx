    ...
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-40 h-full container mx-auto
                        xl:-translate-x-10"> {/* <-- Shift wrapper slightly left on large screens */}
      ...
      <div className="w-[1280px] h-full absolute right-0 bottom-0">
        ...
        {/* desktop side avatar (unchanged, now slightly more right) */}
        <motion.div
          ...
          className="w-full h-full max-w-[737px] max-h-[678px] absolute -bottom-32 
                     lg:bottom-0 lg:right-[5%] xl:right-[10%] hidden xl:flex"> 
          {/* <-- Adjusted right side gap */}
          <Avatar />
        </motion.div>
      </div>
    </div>
